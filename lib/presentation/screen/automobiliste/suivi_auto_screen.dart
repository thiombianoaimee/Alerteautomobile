...
// on cherche le véhicule correspondant dans la liste locale.
if (vehiculeRdv != null) {
for (final vehicule in vehicules) {
if (vehicule["_id"].toString() == vehiculeRdv.toString()) {
...
children: [
  ...
  Text(
    "Date de la dernière visite technique : "
        "${formaterDate(vehicule["dateVisiteTechnique"]?.toString())}",
  ),
...
onPressed: () {
setState(() {
afficherRendezVous = !afficherRendezVous;
});
},
...
String telephoneGaragiste = "Non renseigné";
String adresseGaragiste = "Non renseignée";
...
final vehicule = recupererVehicule(rdv);
...
children: [
  ...
  Text(
    "Téléphone : $telephoneGaragiste",
  ),

  const SizedBox(height: 6),

  Text(
    "Adresse : $adresseGaragiste",
  ),
